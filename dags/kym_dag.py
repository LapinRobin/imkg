...
def cleaning():
    ...
    save2csv('/opt/airflow/data/kym.media.frames.csv', ['title','meme'], [[m['title'],m['url']] for m in raw_media_frames])
...
def extract_related_siblings():
    ...
    seed_raw_media_frames  = json.load(open('/opt/airflow/data/kym.seed.media.frames.json'))

    extract_X(seed_raw_media_frames, '/opt/airflow/data/kym.siblings.media.frames.csv', 'siblings')
